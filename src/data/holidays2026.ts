// Kandil Günleri 2026 (Diyanet Takvimi - Resmi Kaynak)
// Kaynak: https://vakithesaplama.diyanet.gov.tr/icerik.php?icerik=153
...
export const fallbackHolidays2026: Record<string, Array<{date: string, name: string, localName: string}>> = {
    TR: [
        ...
        { date: '2026-03-19', name: 'Eid al-Fitr Eve', localName: 'Ramazan Bayramı Arefesi' },
        { date: '2026-03-20', name: 'Eid al-Fitr 1st Day', localName: 'Ramazan Bayramı 1. Gün' },
        { date: '2026-03-21', name: 'Eid al-Fitr 2nd Day', localName: 'Ramazan Bayramı 2. Gün' },
        { date: '2026-03-22', name: 'Eid al-Fitr 3rd Day', localName: 'Ramazan Bayramı 3. Gün' },
        ...
        { date: '2026-05-26', name: 'Eid al-Adha Eve', localName: 'Kurban Bayramı Arefesi' },
        { date: '2026-05-27', name: 'Eid al-Adha 1st Day', localName: 'Kurban Bayramı 1. Gün' },
        { date: '2026-05-28', name: 'Eid al-Adha 2nd Day', localName: 'Kurban Bayramı 2. Gün' },
        { date: '2026-05-29', name: 'Eid al-Adha 3rd Day', localName: 'Kurban Bayramı 3. Gün' },
        { date: '2026-05-30', name: 'Eid al-Adha 4th Day', localName: 'Kurban Bayramı 4. Gün' },
